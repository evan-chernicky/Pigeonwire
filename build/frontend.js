...
window.addEventListener("DOMContentLoaded", () => {
  ...
  document.fonts.ready.then(() => {
    ...
    if (splitTargets.length) {
      let typeSplit = gsap_SplitText__WEBPACK_IMPORTED_MODULE_2__.SplitText.create(splitTargets, {
        types: "words, chars",
        tagName: "span",
        autoSplit: true,
        onSplit(self) {
          return gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.from(self.words, {
            duration: .8,
            x: 100,
            autoAlpha: 0,
            stagger: 0.02
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function animateHero() {
    gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.to(".entry-content", {
      opacity: 1,
      duration: 1
    });
  }
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  menuToggle.addEventListener('click', () => {
    ...
    if (isMobileMenuToggled) {
      _smoothscroll__WEBPACK_IMPORTED_MODULE_1__.smoother.paused(true);
      gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.from(menuNavLinks, {
        opacity: 0,
        y: 20,
        duration: 0.6,
        stagger: 0.2,
      ...
      _smoothscroll__WEBPACK_IMPORTED_MODULE_1__.smoother.paused(false);
    }
  });
});
...
function initHome() {
  ...
  tl.to("body", {
    ...
    duration: 0.35,
    autoAlpha: 0
  }, 0).to(".hero-decoration--container svg path", {
    duration: 0.7,
    fill: "#ffffff"
  }, 0);
}
...
gsap__WEBPACK_IMPORTED_MODULE_0__["default"].utils.toArray(".scale-on-scroll").forEach(el => {
...
const smoother = gsap_ScrollSmoother__WEBPACK_IMPORTED_MODULE_2__.ScrollSmoother.create({
  smooth: .6,
  effects: true
});
    ...
    anchor.addEventListener('click', e => {
      ...
      if (target) {
        ...
        smoother.scrollTo(target, {
          duration: 1.5,
          // seconds for the scroll animation
...
/*!*************************!*\
  ...
  \*************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _js_smoothscroll__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./js/smoothscroll */ "./src/js/smoothscroll.js");
/* harmony import */ var _js_animations__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./js/animations */ "./src/js/animations.js");
/* harmony import */ var _js_entrance_animation__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./js/entrance-animation */ "./src/js/entrance-animation.js");
...
/* harmony import */ var _js_image_animations__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./js/image-animations */ "./src/js/image-animations.js");
...
/* harmony import */ var _scss_front_end_scss__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./scss/front-end.scss */ "./src/scss/front-end.scss");
//js
